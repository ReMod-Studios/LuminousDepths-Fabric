...
public class GoblinSharkEntity extends WaterCreatureEntity implements IAnimatable {
    ...
    public GoblinSharkEntity(EntityType<? extends GoblinSharkEntity> entityType, World world) {
