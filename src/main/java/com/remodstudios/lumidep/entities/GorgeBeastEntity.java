...
public class GorgeBeastEntity extends WaterCreatureEntity implements IAnimatable {
    ...
    public GorgeBeastEntity(EntityType<? extends GorgeBeastEntity> entityType, World world) {
