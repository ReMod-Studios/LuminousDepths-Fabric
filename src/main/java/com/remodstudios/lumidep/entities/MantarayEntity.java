...
public class MantarayEntity extends WaterCreatureEntity implements IAnimatable {
    ...
    public MantarayEntity(EntityType<? extends MantarayEntity> entityType, World world) {
